...
##################------------- practice Question about variabeles ------------------######################
...
# Create a program to store your first and last name in two variables and print your full name by concatenating them.



##################------------- practice Question about Operators ------------------######################
...
##################------------- practice Question about Data Types ------------------######################
...
# Question:
# Write a Python function that takes a variable as input and checks whether it is a list, tuple, set, or dictionary.
# Print the type along with an appropriate message.
...
##################------------- practice Question about Conditional Statements ------------------######################
...
# Write a program to find the factorial of a number using a recursive function with conditional statements.
...
###########################----------- Practice question about Function. ---------------#######################
...
# Write a function factorial(n) to calculate the factorial of a given number using recursion.
